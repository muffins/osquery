 ...
 */
class SplunkLogForwarder : public BufferedLogForwarder {
 public:
  explicit SplunkLogForwarder();
 ...
 private:
   ...
   // TODO: Not sure on this guy.
  //friend class SplunkLoggerTests;
};

class SplunkLoggerPlugin : public LoggerPlugin {
 public:
  /**
 ...
 private:
  ...
  std::shared_ptr<SplunkLogForwarder> forwarder_{nullptr};
